			...
			<View style={styles.container}>
				...
				<ScrollView style={styles.scrollView}>
					...
					<View style={styles.header}>
						...
						<Image
							source={require('/Users/craftomecj/Desktop/Codigo_Code_Assignment/AquariumApp/assets/notification-icon.png')}
					...
					<View style={styles.gridContainer}>
						{[
							...
							>
								<Image
									source={require('/Users/craftomecj/Desktop/Codigo_Code_Assignment/AquariumApp/assets/map-icon.png')}
				...
				<View style={styles.bottomNav}>
					<View style={styles.navItem}>
						<Image
							source={require('/Users/craftomecj/Desktop/Codigo_Code_Assignment/AquariumApp/assets/home-icon.png')}
					...
					<View style={styles.navItem}>
						<Image
							source={require('/Users/craftomecj/Desktop/Codigo_Code_Assignment/AquariumApp/assets/unknown-icon.png')}
							style={styles.navIcon}
						/>
					...
					<View style={styles.navItem}>
						<Image
							source={require('/Users/craftomecj/Desktop/Codigo_Code_Assignment/AquariumApp/assets/three-dot-circle-icon.png')}
							style={styles.navIcon}
						/>
